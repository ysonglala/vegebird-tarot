...
const I18N = {
  zh: {
    ...
    questionTips: '如果需要使用 AI 解读功能，就要描述清楚问题哦。 / For AI readings, please describe your question clearly.',
  ...
  en: {
    ...
    questionTips: 'For AI readings, please describe your question clearly. / 如果需要使用 AI 解读功能，就要描述清楚问题哦。',
